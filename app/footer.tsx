        ...
        <div className="flex flex-row justify-center items-center w-full h-[60%]">
          <div className="flex flex-col justify-center items-center w-1/3 h-full">
            <ul className="">
              ...
              <li>
                <Link href="/nabidka">NABÍDKA</Link>
              </li>
              <li>
                <Link href="/vinarstvi">VINAŘSTVÍ</Link>
              </li>
              <li>
          ...
          <div className="flex flex-col justify-center items-center w-1/3 h-full">
            ...
            <p className="text-left text-xs w-full">
              Email: obchod@hungarianwine.cz
            </p>
            <p className="text-left text-xs w-full">Tel: +420 736 502 958</p>
            {/*<p className="text-left text-xs w-full">
              Facebook:{" "}
              <a href="https://www.facebook.com/hungarianwine.cz/">
                hungarianwine.cz
              </a>
            </p>*/}
          </div>
